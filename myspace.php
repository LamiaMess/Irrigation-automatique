...
<div class="row">
<div class="col-md-12">
<h2>Liste des zones par ferme</h2>
<table class='table table-bordered'>
<tr>
<th>Fermes</th><th>Zones</th><th>Type de Sol</th><th scope="col">Supprimer</th>
...
FROM ferme,zone,users,typesol
WHERE (zone.idferme=ferme.idferme) AND  zone.iduser=ferme.iduser AND (zone.idtypesol=typesol.idtypesol) AND users.username='".$_SESSION['sess_username']."' ORDER BY nomferme ")
as $row) {
echo "<tr>";
echo "<td>" . $row['nomferme'] . "</td>";
echo "<td>" . $row['nomzone'] . "</td>";
echo "<td>" . $row['nomtypesol'] . "</td>";
echo "<td>"." <a class='link-success' href='controller/deleteZone.php?idzone=".$row['idzone']."'>"."Supprimer la zone</a>"."</td>";
echo "</tr>";
}
  ...
  ?>                         
             ...
             <button type="button" class="btn btn-secondary btn-lg "style="margin-left: 80%;margin-right: 50px;">
                 <a   href="addferme1.php" class="link-light">Ajouter une ferme</a>
             </button>
...
echo "<td>"." <a class='link-success' href='controller/deletePlante.php?idplante=".$row['idplante']."'>"."Supprimer la plante</a>"."</td>";
...
echo "</tr>";
  ...
  <div class="btn-group me-4" role="group" aria-label="Second group">
    <button type="button" class="btn btn-success btn-lg"><a   href="addtomarketplace.php" class="link-dark">Ajouter un produit à la market place</a></button>
